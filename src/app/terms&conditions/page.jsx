...
const sections = [
  {
    heading: null,
    body: `This document is an electronic record in terms of Information Technology Act, 2000 and rules there under as applicable and the amended provisions pertaining to electronic records in various statutes as amended by the Information Technology Act, 2000. This electronic record is generated by a computer system and does not require any physical or digital signatures.`,
  },
  {
    heading: null,
    body: `This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://indorichai.in ("Website"), including the related mobile site and mobile application (hereinafter referred to as "Platform").`,
  },
  {
    heading: null,
    body: `The Platform is owned by Indori Chai, a company incorporated under the Companies Act, 1956 with its registered office at 47, Silver Colony, Indore (hereinafter referred to as "Platform Owner", "we", "us", "our").`,
  },
  {
    heading: null,
  ...
  {
    heading: null,
    body: `For the purpose of these Terms of Use, wherever the context so requires "you", "your" or "user" shall mean any natural or legal person who has agreed to become a user/buyer on the Platform.`,
  },
  {
    heading: "Important Notice",
    body: `ACCESSING, BROWSING OR OTHERWISE USING THE PLATFORM INDICATES YOUR AGREEMENT TO ALL THE TERMS AND CONDITIONS UNDER THESE TERMS OF USE, SO PLEASE READ THE TERMS OF USE CAREFULLY BEFORE PROCEEDING.`,
    uppercase: true,
  },
  {
  ...
  },
  {
    ...
    body: `These Terms and any dispute or claim relating to it, or its enforceability, shall be governed by and construed in accordance with the laws of India. All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in India.`,
  },
  {
    heading: "Contact Us",
        ...
        <div className="space-y-10">
          {sections.map((section, i) => (
            <div key={i}>
              ...
              {section.body && (
                <p className={`text-sm leading-7 text-gray-600 ${section.uppercase ? "uppercase tracking-wide font-medium text-gray-700" : ""}`}>
                  {section.body}
                </p>
              )}
              {section.items && (
                <ol className="space-y-4 list-none">
                  {section.items.map((item, j) => (
                    <li key={j} className="flex gap-4">
                      <span className="shrink-0 mt-0.5 w-5 h-5 flex items-center justify-center rounded-full bg-[#fdf3f2] border border-[#e8c5c0] text-[10px] font-semibold text-[#b5433a]">
                        {j + 1}
                      </span>
